...
import org.example.passbatch.repository.booking.BookingEntity;
import org.example.passbatch.repository.booking.BookingStatus;
import org.example.passbatch.repository.notification.NotificationEntity;
import org.example.passbatch.repository.notification.NotificationEvent;
import org.example.passbatch.repository.notification.NotificationModelMapper;
...
public class SendNotificationBeforeClassJobConfig {
    ...
    public SynchronizedItemStreamReader<NotificationEntity> sendNotificationItemReader() {
        JpaCursorItemReader<NotificationEntity> itemReader = new JpaCursorItemReaderBuilder<NotificationEntity>()
                ...
                .parameterValues(Map.of("event", NotificationEvent.BEFORE_CLASS,
                        "sent", false))
                .build();
